...
import MessageDetails from "../../components/realtors/message-details/MessageDetails";
...
test("renders component without crashing", () => {
  act(() => {
    render(<MessageDetails messageDetails={messageDetails} />);
  });
...
test("should display a selection message if no data", () => {
  act(() => {
    render(<MessageDetails messageDetails={null} />);
  });
...
test("should not display a return button in desktop mode", () => {
  act(() => {
    render(
      <MessageDetails messageDetails={messageDetails} isSmallScreen={false} />
    );
  });

  const returnButton = container.querySelector(
    ".message-details-wrapper button.return-button"
  );
  expect(returnButton).toBeNull();
});

test("should display a return button in responsive mode, and fetch a goBack callback when cliking", () => {
